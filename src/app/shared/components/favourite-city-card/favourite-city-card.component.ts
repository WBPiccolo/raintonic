...
export class FavouriteCityCardComponent {
  ...
  // get deducedWeather() {
  //   const temperature = this.favCity.weatherData.daily.temperature_2m;
  //   const humidity = this.favCity.weatherData.daily.relative_humidity_2m;
  //   const apparentTemperature = this.favCity.weatherData.daily.apparent_temperature;
  //   const precipitation = this.favCity.weatherData.daily.precipitation;
  //   const cloudCover = this.favCity.weatherData.daily.cloud_cover;
  //   const windSpeed = this.favCity.weatherData.daily.wind_speed_10m;
  //   const windDirection = this.favCity.weatherData.daily.wind_direction_10m;
  //   const windGusts = this.favCity.weatherData.daily.wind_gusts_10m;
  //   const weatherCode = this.favCity.weatherData.daily.weather_code;
  ...
  getMean(arr: number[]): number {
    return arr.reduce((acc, curr) => acc = acc + curr, 0) / arr.length;
  }
